...
bool loadConfigV2()
{
    ...
    // --- LED-Hardware ---
    const char *ledType = ledHardware["type"] | nullptr;
    const char *ledOrder = ledHardware["order"] | nullptr;
    ...
    if (ledType)
    {
        ...
        else if (strcmp(ledType, "SK6812_RGB") == 0)
        {
            CONFIGV2.ledHardware.type = LED_TYPE_SK6812_RGB;
        }
        else if (strcmp(ledType, "SK6812_RGBW") == 0)
        {
            CONFIGV2.ledHardware.type = LED_TYPE_SK6812_RGBW;
        }
    }

    if (ledOrder)
    {
        if (strcmp(ledOrder, "RGB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RGB;
        }
        else if (strcmp(ledOrder, "RBG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RBG;
        }
        else if (strcmp(ledOrder, "GRB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GRB;
        }
        else if (strcmp(ledOrder, "GBR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GBR;
        }
        else if (strcmp(ledOrder, "BRG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BRG;
        }
        else if (strcmp(ledOrder, "BGR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BGR;
        }
        else if (strcmp(ledOrder, "WRGB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_WRGB;
        }
        else if (strcmp(ledOrder, "WRBG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_WRBG;
        }
        else if (strcmp(ledOrder, "WGRB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_WGRB;
        }
        else if (strcmp(ledOrder, "WGBR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_WGBR;
        }
        else if (strcmp(ledOrder, "WBRG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_WBRG;
        }
        else if (strcmp(ledOrder, "WBGR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_WBGR;
        }
        else if (strcmp(ledOrder, "RWGB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RWGB;
        }
        else if (strcmp(ledOrder, "RWBG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RWBG;
        }
        else if (strcmp(ledOrder, "RGWB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RGWB;
        }
        else if (strcmp(ledOrder, "RGBW") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RGBW;
        }
        else if (strcmp(ledOrder, "RBWG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RBWG;
        }
        else if (strcmp(ledOrder, "RBGW") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_RBGW;
        }
        else if (strcmp(ledOrder, "GWRB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GWRB;
        }
        else if (strcmp(ledOrder, "GWBR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GWBR;
        }
        else if (strcmp(ledOrder, "GRWB") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GRWB;
        }
        else if (strcmp(ledOrder, "GRBW") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GRBW;
        }
        else if (strcmp(ledOrder, "GBWR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GBWR;
        }
        else if (strcmp(ledOrder, "GBRW") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_GBRW;
        }
        else if (strcmp(ledOrder, "BWRG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BWRG;
        }
        else if (strcmp(ledOrder, "BWGR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BWGR;
        }
        else if (strcmp(ledOrder, "BRWG") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BRWG;
        }
        else if (strcmp(ledOrder, "BRGW") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BRGW;
        }
        else if (strcmp(ledOrder, "BGWR") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BGWR;
        }
        else if (strcmp(ledOrder, "BGRW") == 0)
        {
            CONFIGV2.ledHardware.order = LED_ORDER_BGRW;
        }
    }
    ...
    void applyConfigV2()
    {
        ...
        if (CONFIGV2.system.debugMode)
        {
            ...
            Serial.println(BUZ_PIN);
            Serial.print(F(" activeHigh="));
            Serial.println(CONFIGV2.buzzer.activeHigh);
            Serial.print(F(" freq="));
            Serial.println(CONFIGV2.buzzer.freqHz);
            Serial.print(F(" Hz single="));
            Serial.println(CONFIGV2.buzzer.singleMs);
            Serial.print(F(" ms dblOn="));
            Serial.print(CONFIGV2.buzzer.doubleOnMs);
            Serial.print(F(" ms dblGap="));
            Serial.println(CONFIGV2.buzzer.doubleGapMs);
            Serial.print(F(" ms errOn="));
            Serial.println(CONFIGV2.buzzer.errorOnMs);
            Serial.print(F(" ms errGap="));
            Serial.println(CONFIGV2.buzzer.errorGapMs);
            Serial.print(F(" ms errCount="));
    ...
    bool importConfigJsonV2(JsonObject src)
    {
        ...
        if (src["system"].is<JsonObject>())
        {
            ...
            if (CONFIGV2.system.debugMode)
            {
                ...
                Serial.print(F("  Hostname: "));
                Serial.println(CONFIGV2.system.hostname);
                Serial.print(F("  Web LED Timeout: "));
                Serial.println(CONFIGV2.system.webLEDTimeout);
                Serial.print(F("  Darkmode: "));
                Serial.println(CONFIGV2.system.darkmode ? F("true") : F("false"));
                Serial.print(F("  Debug Mode: "));
                Serial.println(CONFIGV2.system.debugMode ? F("true") : F("false"));
                Serial.print(F("  Animation After Boot: "));
                Serial.println(CONFIGV2.system.animationAfterBoot ? F("true") : F("false"));
        ...
        if (src["led"].is<JsonObject>())
        {
            ...
            if (CONFIGV2.system.debugMode)
            {
                ...
                Serial.println(CONFIGV2.led.brightness);
                Serial.print(F("  LED timeout: "));
                Serial.println(CONFIGV2.led.timeout);
                Serial.print(F("  LED color: 0x"));
                Serial.println(CONFIGV2.led.color, HEX);
                Serial.print(F("  LED error color: 0x"));
                Serial.println(CONFIGV2.led.colorError, HEX);
                Serial.print(F("  LED pulse color: 0x"));
                Serial.println(CONFIGV2.led.colorPulse, HEX);
            }
        }
        ...
        if (src["nfc"].is<JsonObject>())
        {
            ...
            if (CONFIGV2.system.debugMode)
            {
                ...
                Serial.print(F("  NFC count: "));
                Serial.println(CONFIGV2.nfc.count);
                Serial.print(F("  NFC brightness: "));
                Serial.println(CONFIGV2.nfc.brightness);
                Serial.print(F("  NFC timeout: "));
                Serial.println(CONFIGV2.nfc.timeout);
                Serial.print(F("  NFC success color: 0x"));
                Serial.println(CONFIGV2.nfc.colorSuccess, HEX);
                Serial.print(F("  NFC error color: 0x"));
                Serial.println(CONFIGV2.nfc.colorError, HEX);
                Serial.print(F("  NFC pulse color: 0x"));
                Serial.println(CONFIGV2.nfc.colorPulse, HEX);
                Serial.print(F("  NFC success blink enabled: "));
                Serial.println(CONFIGV2.nfc.successBlinkEnabled ? F("true") : F("false"));
                Serial.print(F("  NFC success blink count: "));
                Serial.println(CONFIGV2.nfc.successBlinkCount);
            }
        }
        ...
        if (src["button"].is<JsonObject>())
        {
            ...
            if (CONFIGV2.system.debugMode)
            {
                ...
                Serial.print(F("  Button enabled: "));
                Serial.println(CONFIGV2.button.enabled ? F("true") : F("false"));
                Serial.print(F("  Button pullup: "));
                Serial.println(CONFIGV2.button.pullup ? F("true") : F("false"));
                Serial.print(F("  Button debounceMs: "));
                Serial.println(CONFIGV2.button.debounceMs);
                Serial.print(F("  Button longMs: "));
                Serial.println(CONFIGV2.button.longMs);
                Serial.print(F("  Button doubleGapMs: "));
                Serial.println(CONFIGV2.button.doubleGapMs);
                Serial.print(F("  Button holdRepeatMs: "));
                Serial.println(CONFIGV2.button.holdRepeatMs);
            }
        }
        ...
        if (src["buzzer"].is<JsonObject>())
        {
            ...
            if (CONFIGV2.system.debugMode)
            {
                ...
                Serial.print(F("  Buzzer enabled: "));
                Serial.println(CONFIGV2.buzzer.enabled ? F("true") : F("false"));
                Serial.print(F("  Buzzer activeHigh: "));
                Serial.println(CONFIGV2.buzzer.activeHigh ? F("true") : F("false"));
                Serial.print(F("  Buzzer freqHz: "));
                Serial.println(CONFIGV2.buzzer.freqHz);
                Serial.print(F("  Buzzer singleMs: "));
                Serial.println(CONFIGV2.buzzer.singleMs);
                Serial.print(F("  Buzzer doubleOnMs: "));
                Serial.println(CONFIGV2.buzzer.doubleOnMs);
                Serial.print(F("  Buzzer doubleGapMs: "));
                Serial.println(CONFIGV2.buzzer.doubleGapMs);
                Serial.print(F("  Buzzer errorOnMs: "));
                Serial.println(CONFIGV2.buzzer.errorOnMs);
                Serial.print(F("  Buzzer errorGapMs: "));
                Serial.println(CONFIGV2.buzzer.errorGapMs);
                Serial.print(F("  Buzzer errorCount: "));
                Serial.println(CONFIGV2.buzzer.errorCount);
            }
        }
        ...
        if (src["mqttConfig"].is<JsonObject>())
        {
            ...
            if (CONFIGV2.system.debugMode)
            {
                ...
                Serial.print(F("  MQTT clientId: "));
                Serial.println(CONFIGV2.mqttConfig.clientId);
                Serial.print(F("  MQTT haDiscovery: "));
                Serial.println(CONFIGV2.mqttConfig.haDiscovery ? F("true") : F("false"));
                Serial.print(F("  MQTT haDiscoveryPrefix: "));
                Serial.println(CONFIGV2.mqttConfig.haDiscoveryPrefix);
            }
        }
